...
public class ChatFragment extends Fragment {
    ...
    public void onStart() {
        ...
        FirebaseRecyclerOptions<Conv> convFirebaseRecyclerOptions = new FirebaseRecyclerOptions.Builder<Conv>()
                .setQuery(conversationQuery,Conv.class)
                .build();
        firebaseConvAdapter = new FirebaseRecyclerAdapter<Conv, ConvViewHolder>(
                convFirebaseRecyclerOptions
        ) {
            @Override
            protected void onBindViewHolder(@NonNull final ConvViewHolder holder, int i, @NonNull final Conv model) {
                ...
                lastMessageQuery.addChildEventListener(new ChildEventListener() {
                    ...
                    public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                        ...
                        holder.setMessage(data, model.isSeen(),type);
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        holder.mView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                chatIntent.putExtra("chat_user_image", userThumb);
